...
struct KeychainItem {
    ...
    static var currentEmail: String {
        do {
            let storedIdentifier = try KeychainItem(service: "email", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain(service: String) {
        do {
